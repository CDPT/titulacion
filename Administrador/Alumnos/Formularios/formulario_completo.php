...
class accion{
    public function extrmaestro(){
      $consulta5=mysql_query("SELECT * FROM profesor order by apellido_paterno,apellido_materno,nombre");
          ...
          <td>
            ...
            <tr>
              ...
              <td>
                ...
                ?>
                <input class="textform" type="text" name="titulotrab" id="titulotrab" value="<?php print $titulotrab?>" maxlength="1000"></td>
              </tr>
