...
*/
                ...
                $("#periodo_tit").change(function(event){
                    var matricula = $("#matricula").val();
                    var periodo = $("#periodo_tit").find(':selected').val();
                    var nuper = $("#numper").val();
                    $("#period").load('valida/valida_periodo.php?mat='+matricula+'&periodo='+periodo+'&nuper='+nuper);
                });
                ...
                $("#director").change(function(event){
                    ...
                    $("#transaccion").load('valida/cuerpo_academico.php?mat='+matricula+"&dir="+dir+"&op=1"+"&prop1="+prop1+"&sup1="+sup1);  
               });
              ...
              $i++;
               ...
               if ($id_period==$id_perio) { ?>
                 <option value="<?php print $id_perio ?>" selected><?php print $perio; ?> </option> 
                   <input type="hidden" name="numper" id="numper" value="<?php print $i; ?>">
             <?php  }else{ ?>
...
<thead id="tipoca"></thead>
<!--<tbody id="eleccion" style="display:<?php if($tipoca=='1'){ print 'none'; }else{print 'block';} ?>;">-->
<tbody id="eleccion" style="display:none;">  


          <tr>
            <td class="titform"><div id="tit1">Sinodal Propietario 1</div></td>
            <?php
        ...
        <tr>
          <td class="titform"><div id="tit2">Sinodal propietario 2</div></td>
          <?php
...
<!--<tbody id="sica" style="display:<?php if($tipoca=='1'){ print 'none'; }else{print 'block'; } ?>;">-->
<tbody id="sica" style="display:none;">
          ...
          <td>
            <!--<section >-->
              <?php
                ...
                $salo=$sa['salon'];
              ?> 
          <section id="seccion_salon" style="display:<?php  if($salo==""){print "none";}else{print "block";} ?>;">
<!--  
