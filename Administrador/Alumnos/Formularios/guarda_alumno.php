...
$tipo_alumno = mysql_fetch_array($compara_matricula);
...
<?php
if($cons){
	if($tipo_alumno['tipo']=='ER' || $tipo_alumno['tipo']==''){
		$actualizacion="UPDATE formulario SET tipo='CAT' Where matricula='$matricula'";
	...
	$apemat=$fila['apemat'];
		...
		<script> 
				   ...
				   var ma="<?php print $apemat ?>";
			        alert( no+" "+pa+" "+ma+" ha sido cambiado al CAT  ");
...
$guardar2="INSERT INTO formulario_er (matricula, submodalidad) VALUES ('$matricula','Trabajo')";
