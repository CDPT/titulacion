...
$consulta=("UPDATE  alumno  SET nombre='$nombre', apepat='$apepat', apemat='$apemat', matricula_interna='$matinterna', celular='$cel', correo='$correo', calle='$calle',colonia='$colonia',codigo_postal='$codigo',ciudad='$ciudad',tel_emergencia='$tel' WHERE matricula='$matricula'");
