...
$guardar=mysql_query("INSERT INTO periodo (fecha_ini, fecha_fin, periodo, estado) VALUES('$periodo_inicio' , '$periodo_fin', '$periodo', '1') ")or die("no se pudo realizar la consulta");
