...
$consula_curso=mysql_query("SELECT * FROM formulario_cat WHERE matricula='$matricula' ");
...
$periodo=mysql_query("SELECT `periodo` FROM `periodo` , `formulario` WHERE `id_periodo` = `periodo_tit` AND `matricula` = '$matricula'");
$periodo=mysql_fetch_array($periodo);
	...
	<section id="cuadroedita">
		...
		<form action="index.php" method="post">
			...
			<form id="formulrecibo" name="formulrecibo" method="post" action="guardar_pago.php">	
				...
				<input type="hidden" name="fecha_curso" value="<?php print $grupo; ?>">
				<input type="hidden" name="matricula" value="<?php print $matricula; ?>">
			  ...
			  <table class="tabla_form">
			    ...
			    <tr>
			    	<td><label class="lbltab">Periodo:</label></td>
