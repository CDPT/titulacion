	...
	<tr>
		...
		<td> 
			<a href="Buscador/index.php">
				...
				<section class="subtit">Buscar Estudiantes UV</section>
			</a>
		</td>
		...
		<td>
			<a href="Formularios/formulario_nuevo.php">
				<section class="borde">
			   	...
			   	<section class="subtit">Agregar Estudiantes CAT</section>
		   	</a>
		</td>
		...
		<td> 
			<a href="Listado/index.php">
				<section class="borde">
			    	...
			    	<section class="subtit">Listado Estudiantes CAT</section>
		  	</a>  
		</td>
