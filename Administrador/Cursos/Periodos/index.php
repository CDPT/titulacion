...
<table>
	<tr>
		...
		<td> 
			<a href="formato_agrega_periodo.php">
				<section class="borde">
					<img src="../../../Imagenes/agregar_periodo.png" alt="" width="125" height="125"/></a> 
				</section>
				<section class="subtit">Agregar Perido </section>
			</a>
		</td>
		...
		<td>
			<a href="listado_periodos.php">
				<section class="borde">
			   		<img src="../../../Imagenes/lista_periodos.png" alt="" width="125" height="125"/> 
			   	</section>
			   	<section class="subtit" >Lista Periodos</section>
		   	</a>
		</td>
</table>				
