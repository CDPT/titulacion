...
<form id="form1" name="form1" method="post" action="guarda_cuota.php">

	<table>
		<tr>
			<td>Concepto</td>
			<td><input type="text" name="concepto" maxlength="20" /></td>
		</tr>

		<tr>
			<td>Monto</td>
			<td><input type="text" name="monto" onkeyUp="return ValNumero(this);" maxlength="10"/></td>
		</tr>
