...
<!--
		...
		<tr>
			<td>Capacidad</td>
			<td><input type="text" name="capacidad" onkeyUp="return ValNumero(this);" maxlength="3" required/></td>
		</tr>
<!--	
		<tr>
			<td>Total</td>
		...
		<tr>
			...
			<td>
				<select name="periodo" required>
					<option></option>
<?
$consulta=mysql_query("SELECT * FROM periodo WHERE estado='1'")or die("nos epuedo");
