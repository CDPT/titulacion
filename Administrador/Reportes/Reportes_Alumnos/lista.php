...
<div id="imagen">
   ...
   <img src="../../../pdf/uv.jpg"  width="100px" height="100px"/>
	...
	<p align="left"><b style="text-transform:uppercase;">PERIODO: <?php echo $nombreperiodo; ?></br>
		<b style="text-transform:uppercase;">CARRERA: <?php echo $carrera_nombre; ?></br>
	...
	<tr>
		<td><b>Matricula</b></td>
		<td><b>Nombre</b></td>
		<?php if ($periodo=="0"){echo "<td><b>Periodo</b></td>";}?>
		<?php if ($carrer=="0"){echo "<td><b>Programa<br>Educativo</b></td>";}?>
		<?php if ($estatu=="0"){echo "<td><b>Estado</b></td>";}?>
		<?php if ($grupo=="0"){echo "<td><b>Grupo</b></td>";}?>
...
?>
	<tr>
		...
		<?php if ($periodo=="0"){echo "<td >".$nom_pe."</td>";}?>
		<?php if ($carrer=="0"){echo "<td >".$carrera."</td>";}?>
		<?php if ($estatu=="0"){echo "<td >".$estado."</td>";}?>
		<?php if ($grupo=="0"){echo "<td >".$grupo1."</td>";}?>
		<td>________________</br></td>
	</tr>
