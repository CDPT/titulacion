							...
							<tr>
								...
								<td>
									<select name="periodo">	
										...
										<?php
										$consula_periodo=mysql_query("SELECT * FROM periodo WHERE estado='1' order by fecha_fin DESC");
								...
								<tr>
									...
									<td>
										<select name="grupo">	
											<option value='0'>Todos</option>
											<?php
											$consula_grupo=mysql_query("SELECT * FROM grupos  WHERE estado='1'");
											while($fila=mysql_fetch_array($consula_grupo)){
												$nombre_grupo=$fila['nombre_grupo'];
												?>
												<option value='<?php echo $nombre_grupo; ?>'><?php echo $nombre_grupo; ?></option>
												<?php } ?>
											</select>
										</td>
									</tr>
