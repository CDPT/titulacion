...
<div id="imagen">
   ...
   <img src="../../../pdf/uv.jpg"  width="100px" height="100px"/>
	...
	<p align="right">Xalapa, Ver. a <?php echo $dia." de ".$mes_nombre." del ".$year;?><br>
	<p align="left"><b>Periodo:</b> <?php echo $nombreperiodo; ?><br><br>
...
$director=$nombredir." ".$apepatdir." ".$apematdir;
if($director=="   ") $director="-";
if($modalida=="") $modalida="-";
if ($nomtrab=="")$nomtrab="-";
?>
	<tr>
