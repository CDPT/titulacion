					...
					<table>
						<tr>
							...
							<td>
								<a href="Reportes_Deudores/index.php">
									<section class="borde">
										<img src="../../Imagenes/reportes7.png" alt="" width="125" height="125"/> 
									</section>
									<section class="subtit" >Relaci&oacuten de Deudores</section>
								</a>
							</td>
						</tr>
						...
						<td>
							<a href="Reportes_Examenes/index.php">
								<section class="borde">
									<img src="../../Imagenes/reportes6.png" alt="" width="125" height="125"/> 
								</section>
								<section class="subtit" >Reporte Examenes</section>
							</a>
						</td>

						<td>
							<a href="Reportes_Periodos/index.php">
								<section class="borde">
									<img src="../../Imagenes/reportes1.png" alt="" width="125" height="125"/> 
								</section>
								<section class="subtit" >Relaci&oacuten por Periodos</section>
							</a>
						</td>

						<td>
							<a href="Reportes_Correos/index.php">
								<section class="borde">
									<img src="../../Imagenes/ListaCorreos.png" alt="" width="125" height="125"/> 
								</section>
								<section class="subtit" >Lista Correos</section>
							</a>
						</td>
					</table>
