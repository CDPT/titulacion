...
<section id="mensajebusca">
		...
		<section id="contiene_consulta"> 			
				<form id="formuldatos" method="post" name="formuldatos" action="../Formularios/guarda_alumno.php? matricula=<?php print $clave ?>" >
				<table  border="0">
			            <tr>
						...
						?>
							   	...
							   	<tr> 
			                        ...
			                        <?php if ($row_cnt==1){ ?>
			                        <td>
			                        	<input type="image" id="guarda" value="Registrar" name="guardar_registro" src='../../../Imagenes/alumnos/registrar.png'>
			                        	<?php
						                //echo "<a href='#' onclick='agregar();'><img src='../../../Imagenes/alumnos/registrar.png'></a>";
						                ?>
