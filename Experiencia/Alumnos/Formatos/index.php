...
<table>
	<tr>
		...
		<td> 
			<form method="post" action="ER5/ER5.php">
				...
				<section class="borde">
			   	...
			   	<section class="subtit">ER5</section>
		   	</form>

		</td>
		<?php }elseif($submodalidad=="Ceneval"){ ?>
		<td>
			<form method="post" action="ER5_ceneval/ER5_ceneval.php">
				<input type="hidden" value="<?php print $matricula; ?>" name="matricula">
				<section class="borde">
			   		<input type="image" src="../../../Imagenes/reportes2.png" alt="" width="125" height="125"/> 
			   	</section>
			   	<section class="subtit">ER5 por Ceneval</section>
		   	</form>
		</td>
		<?php }elseif($submodalidad=="Promedio"){?>
		<td>
			<form method="post" action="ER5_promedio/ER5_promedio.php">
				<input type="hidden" value="<?php print $matricula; ?>" name="matricula">
				<section class="borde">
			   		<input type="image" src="../../../Imagenes/reportes2.png" alt="" width="125" height="125"/> 
			   	</section>
			   	<section class="subtit">ER5 por Promedio</section>
		   	</form>
		</td>
		<?php }?>
	</tr>
