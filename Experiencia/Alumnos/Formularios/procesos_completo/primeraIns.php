    ...
    <form id="formuldatos" method="post" name="formuldatos" action="procesos_completo/edita_datos_generales.php? matricula=<?php print $matricula ?>" >
          ...
          <table class="tabla_form" border="0">
                  ...
                  <tr>
                    ...
                    <td><input class="textform_mail" type="text" maxlength="10" value="<?php print $tipo?>" readonly/></td>
                  </tr>  
                   <tr>
    ...
    <form method="POST" id="formuldatos2" style="display:none"  action="procesos_completo/edita_datos_titulacion.php? matricula=<?php print $matricula?>">
        ...
        <tr>
          ...
          <tr>
            ...
            <td><select class="selectopcion"  name="inscripcion" id="inscripcion">
...
<?php if($submodalidad=="Trabajo" || $submodalidad==""){ ?>
      <section id="resin">
        <table  class="tabla_form" style="margin-top:-40px; margin-left:50px;">
        <tr id="sup1">
...
<table class="tabla_form">
 ...
 <?php 
  ...
  if($cuenta==1){?>
      ...
      <p align="right"><a href="primeraIns.php? matricula=<?php echo $matricula;?>" target="_blank"><legend class="legendform">Imprimir Constancia</legend></a></p>
