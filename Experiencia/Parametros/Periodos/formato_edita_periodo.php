...
<form id="form1" name="form1" method="post" action="edita_periodo.php? id=<? print $id; ?>">

	<table>
		<tr>
			<td>Periodo Inicio</td>
			<td><input type="text" name="periodo_inicio" id="periodo_inicio" value="<? print $inicio; ?>" maxlength="10" /></td>
		</tr>

		<tr>
			<td>Periodo Fin</td>
			<td><input type="text" name="periodo_fin" id="periodo_fin" value="<? print $fin; ?>" maxlength="10"/></td>
		</tr>
