...
<section id="titformulintro">
  Relaci&oacuten de Examenes Realizados
</section>
...
<table id="tabla" class="tabla" cellspacing="20">
	<tr>
		...
		<td>
			<select name="periodo" required>	
				...
				<?php
				$consula_periodo=mysql_query("SELECT * FROM periodo order by fecha_ini desc");
		...
		<td>
			<select name="profesor" required>	
				...
				<?php   
                $consulta_profesor=mysql_query("SELECT * FROM profesor order by apellido_paterno");
	...
	<tr>
		...
		<td><select name="carrera">
			...
			<option value="LS">LSCA</option>
			<option value="LN">LGDN</option>
		</select></td>
	</tr>
<tr>
