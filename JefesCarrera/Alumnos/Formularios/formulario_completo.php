    ...
    <form id="formuldatos" method="post" name="formuldatos" action="procesos_completo/edita_datos_generales.php? matricula=<?php print $matricula ?>" >
          ...
          <table class="tabla_form" border="0">
                  ...
                  <tr>
                    ...
                    <td><input type="text" class="textform" value="<?php print $nombre; ?>" id="nombre" name="nombre"/></td>
                  </tr>

                  <tr>
                    <td class="titform">Apellido Paterno:</td>
                    <td><input type="text" class="textform" value="<?php print $apepat; ?>" id="apepat" name="apepat"/></td>
                  </tr>

                  <tr>
                    <td class="titform">Apellido Materno:</td>
                    <td><input type="text" class="textform" value="<?php print $apemat ; ?>" id="apemat" name="apemat"/></td>
                  </tr>

                  <tr>
                    <td class="titform">Carrera:</td>
                    <td><input type="text" class="textform" value="<?php print $carrera ; ?>" id="carrera" name="carrera" readonly/></td>
                  </tr>

                  <tr>
                    <td class="titform">Calle:</td>
                    <td><input class="textform" name="calle" type="text" id="calle" value="<?php print $calle ; ?>" required></td>
                  </tr>

                  <tr>
                    <td class="titform">Colonia:</td>
                    <td><input class="textform" type="text" name="colonia" value="<?php print $colonia; ?>" id="colonia"  required></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td><input class="textform" type="text" name="ciudad" value="<?php print $ciudad ?>" id="ciudad" required></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td><input class="textform_mail" type="text" value="<?php print $tip?>" readonly/></td>
                  </tr> 
                  <tr>
                   ...
                   <tr>
                    ...
                    <td><input class="textform_mail" type="text" value="<?php print $calificacion?>" readonly/></td>
                  </tr> 
...
<?php 
  $co3=mysql_query("SELECT * FROM formulario_er WHERE matricula='$matricula'");
  $fi=mysql_fetch_array($co3);
  $submodalidad=$fi['submodalidad'];
  $inscripcion=$fi['inscripcion'];
  $fecen=$fi['protocolo'];
  $calif=$fi['calificacion'];
?>
        </tr>
          <tr>
            <td class="titform">No. de Inscripción</td>
            <td><input type="text" class="textform"  name="inscripcion" id="inscripcion" value="<?php echo $inscripcion; ?>" readonly></td>
          </tr>
          <?php if($submodalidad=="Trabajo"){ ?>
            <tr>
              ...
              <td>
                ...
                ?>
                <input class="textform" type="text" name="titulotrab" id="titulotrab" value="<?php print $titulotrab?>" title="<?php print $titulotrab?>" readonly></td>
              </tr>
<?php } ?>
          <tr>
            <td class="titform">Modalidad</td>
            <td><input class="textform" type="text" name="submodalidad" id="submodalidad" value="<?php echo $submodalidad; ?>" readonly></td>
          </tr>
          <?php if($submodalidad=="Trabajo"){ ?>
            <tr>
              ...
              <td>
                <?php
                 ...
                 ?>
                 <input type="text" class="textform" name="modalidad" id="modalidad" value="<?php print $modali; ?>" readonly>
              </td>
            </tr>
<?php } ?>
...
<?php } 
  if ($submodalidad=="Ceneval") {
?>
    <tr>
      <td class="titform">Fecha de Examen</td>
      <td><input type="text" class="textform" name="fecen" id="fecen" value="<?php print $fecen; ?>" readonly/></td>
    </tr>
    <tr>
      <td class="titform">Calificación</td>
      <td><input type="text" class="textform" name="calif" id="calif" value="<?php print $calif; ?>" readonly/></td>
    </tr>
    <?php } ?>
