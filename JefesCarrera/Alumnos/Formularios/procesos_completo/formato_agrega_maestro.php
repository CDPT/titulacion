...
<section id="edit" style="display:none;" >
	<section id="cuadroedita">
		<a href="../formulario_completo.php? matricula=<?php print $matricula ?>" class="close">
			<img src="../../../../Imagenes/error.png" class="btn_close" title="Close Window" alt="Close" />
		</a>
<form id="form1" name="form1" method="post" action="agrega_maestro.php?  matricula=<?php print $matricula ?>">
