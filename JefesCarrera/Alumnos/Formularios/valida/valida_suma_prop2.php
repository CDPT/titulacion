...
// cuenta director
	$consulta1=mysql_query("SELECT COUNT(formulario.matricula) FROM formulario where (formulario.sinprop1='$prop2' or formulario.sinprop2='$prop2') and tit='0' and periodo_tit='$idper'" ) or die (mysql_error());
	$cuentadir=mysql_result($consulta1, 0);

	if($idper==$periodo){
		$totDirAc=$cuentadir;
	// cuenta todos
		$consultatot=mysql_query("SELECT COUNT(formulario.matricula) FROM formulario where (formulario.director='$prop2' or formulario.sinprop1='$prop2' or formulario.sinprop2='$prop2') and tit='0' and periodo_tit='$idper'") or die (mysql_error());
