...
$apemat=$fila['apemat'];
	 ...
	 print $nombre." ".$apepat." ".$apemat." ya ha sido registrada anterior mente busquel@ en LISTADO DE ALUMNOS  ";
	 ?>
	 <form action="../listado/index.php? mat=<?php print $matricula; ?>">
			    ...
			    <script> 
				   ...
				   var ma="<?php echo $apemat; ?>";
			        alert( no+" "+pa+" "+ma+" ya ha sido registrada anterior mente busquel@ en LISTADO DE ALUMNOS");
...
$consulta_salon=mysql_query("SELECT * FROM  cat_salon order by no_salon");
