...
$guardar=mysql_query("INSERT INTO periodo_cat (fecha_ini, fecha_fin, periodo, estado) VALUES('$periodo_inicio' , '$periodo_fin', '$periodo', '1') ")or die("no se pudo realizar la consulta");

if($guardar){
?>		
<script type="text/javascript">
	alert("Se Guardo Correctamente");
	//document.location.href=("../formulario_completo.php");
