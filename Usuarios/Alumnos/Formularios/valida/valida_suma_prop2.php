...
<?php }else{
	if ($prop2==$dir || $prop2==$prop1 || $prop2==$sup1 || $prop2==$sup2){ ?>
<script>
		$("#observa").html("");	
...
$consulta1=mysql_query("SELECT COUNT(sinprop2) FROM formulario WHERE sinprop2='$prop2' and periodo_tit='$periodo'  ");
	$fila=mysql_fetch_array($consulta1);
		$cuenta=$fila['COUNT(sinprop2)'];
