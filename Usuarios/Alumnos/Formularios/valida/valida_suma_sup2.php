...
$consulta1=mysql_query("SELECT COUNT(sinsup2) FROM formulario WHERE sinsup2='$sup2' and periodo_tit='$periodo'  ");
	$fila=mysql_fetch_array($consulta1);
		$cuenta=$fila['COUNT(sinsup2)'];
...
$dir2=$sup2."-pen";
?>
<input type="hidden" name="sinsup2" value="<?php echo $dir2; ?>" >
