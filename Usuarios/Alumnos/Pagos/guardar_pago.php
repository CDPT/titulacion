...
$consulta_matricula="SELECT * FROM formulario_cat WHERE matricula='$matricula'";
	...
	$falta=($monto+$sinodal)-$total;
                  ...
                  $consulta="INSERT INTO pagos_cat(matricula,fecha,tipo_pago,monto_pago,concepto)
                  VALUES
                  ...
                  <table width="359" height="194" border="0" align="center">
                    ...
                    <tr>
                      <td><strong>Fecha de Curso:</strong></td>
                  ...
                  <p align="center">  <a target="_blank" href="../../../pdf/recibo_sinodal.php? nombre=<?php echo $nombre?> & apepat=<?php echo $apepat?> & apemat=<?php echo $apemat?> & fecha_curso=<?php echo $fecha_curso?> & tipo_pago=<?php echo $tipo_pago?> & resultado=<?php echo $resultado?> & importe=<?php echo $importe?> ">
                    <input src="../../../Imagenes/alumnos/impresora.png" type="image"/></a>
                    </p>
                    <?php }else{ ?>
                    <p align="center">  <a target="_blank" href="../../../pdf/recibo.php? nombre=<?php echo $nombre?> & apepat=<?php echo $apepat?> & apemat=<?php echo $apemat?> & fecha_curso=<?php echo $fecha_curso?> & tipo_pago=<?php echo $tipo_pago?> & resultado=<?php echo $resultado?> & importe=<?php echo $importe?> ">
                    <input src="../../../Imagenes/alumnos/impresora.png" type="image"/></a>
                    </p>
                    <?php } ?>
                  </fieldset>
