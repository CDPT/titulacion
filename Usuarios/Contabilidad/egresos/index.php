...
?>
            ...
            <form id="regresar" method="post" action="../index.php">
				...
				<p align="right"><a href="egresos.php"><legend class="legendform">Total de Egresos</legend></a></p>
<fieldset>
<legend class="legendform">Egresos</legend><br>
<form action="guardar.php" method="post">
	<input type="hidden" name="fecha" vaue="<?php echo $fecha; ?>">
<table border="0" cellspacing="30px">
    ...
    <tr>
        ...
        <td><input class="textform" type="text" name="nombre" autofocus required maxlength="30"></td>
	</tr>
    <tr>
    	<td class="titform">Grupo:</td>
        <td><input class="textform" type="text" name="grupo" required maxlength="10"></td>
    </tr>
    <tr>
		<td class="titform">Concepto:</td>
        <td><input type="text" class="textform" name="concepto" style="color:#005baa;" required maxlength="30"></td>
	</tr>
    <tr>
		<td class="titform">Importe:</td>
        <td><input class="textform" type="text" name="importe" onkeyUp="return ValNumero(this);" required maxlength="10"></td>
	</tr>
    <tr>
