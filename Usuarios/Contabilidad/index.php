...
<table>
	<tr>
		...
		<td> 
			<a href="ingresos/index.php">
				<section class="borde">
					<img src="../../Imagenes/contabilidad/ingresos.png" alt="" width="125" height="125"/></a> 
				</section>
				<section class="subtit">Reposición de Gastos</section>
			</a>
		</td>
		...
		<td>
			<a href="egresos/index.php">
				<section class="borde">
			   		<img src="../../Imagenes/contabilidad/egresos.png" alt="" width="125" height="125"/> 
			   	</section>
			   	<section class="subtit" >Egresos</section>
		   	</a>
		</td>
