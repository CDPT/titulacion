...
include "../../../Scripts/conexion.php";
	  	...
	  	$query=mysql_query("SELECT * FROM cat_profesor WHERE nombre LIKE '%$clave%' order by nombre ");
...
?> 
		...
		<section id="tablabuscar"> 
			<form action="../Formularios/formulario_intro.php" method="post" action="index.php" >
				<table  border="0">
			            <tr>
						...
						?>
						   	<tbody align="center" class="cont_tabla" >
							   	<tr> 
									<td><input class="textfiltab" type="text" name="matricula" size="9" value= "<? print $row['no_personal']; ?>" readonly="readonly" /></td>
