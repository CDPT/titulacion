...
if(isset($_REQUEST['bus'])){
	...
	$consul="SELECT * FROM cat_profesor WHERE nombre LIKE '%$bus%' ORDER BY nombre ";
}else{
	$consul="SELECT * FROM cat_profesor ORDER BY nombre LIMIT $RegistrosAEmpezar, $RegistrosAMostrar ";	
}
...
$NroRegistros=mysql_num_rows(mysql_query("SELECT * FROM cat_profesor"));
$PagAnt=$PagAct-1;
$PagSig=$PagAct+1;
