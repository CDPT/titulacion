...
<section id="edit" style="display:none;">
	<section id="cuadroedita">
		<a href="listado_cuotas.php" class="close">
			<img src="../../../Imagenes/error.png" class="btn_close" title="Close Window" alt="Close" />
		</a>
<form id="form1" name="form1" method="post" action="edita_cuota.php">
	<input type="hidden" name="id" value="<?php print $id; ?>">
	<table>
		<tr>
			<td>Concepto</td>
			<td><input type="text" name="concepto" value="<?php print $concepto; ?>"/></td>
		</tr>

		<tr>
			<td>Monto</td>
			<td><input type="text" name="monto" value="<?php print $monto; ?>" onkeyUp="return ValNumero(this);"/></td>
		</tr>
