...
$guardar=mysql_query("INSERT INTO grupos_cat (nombre_grupo,capacidad,total,periodo,estado) VALUES('$nombre','$capacidad','0','$periodo','1') ")or die("no se pudo realizar la consulta");
