...
<span class="titulo"> UNIVERSIDAD VERACRUZANA</span><br>
	...
	<p align="right"> <b>BUENO POR:</b> $'.number_format($importe).'.00</p>
		<p align="center"><b>RECIB&Iacute; DE:</b> '.$valor.'<br>
		<b>MATRICULA:</b> '.$matricula.'<br>
		<b>LA CANTIDAD DE:</b> '.$resultado.' PESOS 00/100 M.N.<br></p>

		Por concepto de adelanto de pago al Curso-Taller para la Titulaci&oacute;n y Servicios de Titulaci&oacute;n en monto Total('.$tipo1.') Abono ('.$tipo2.'), que se imparte a trav&eacute;s del Centro de Apoyo a la Titulaci&oacute;n (CAT).<br><br>
		<b>GRUPO:</b> '.$fecha_curso.'<br>
...
<span class="titulo"> UNIVERSIDAD VERACRUZANA</span><br>
	...
	<p align="right"> <b>BUENO POR:</b> $'.$importe.'.00</p>
		...
		<p align="center">Xalapa, Ver. A '.$dia_mes." de ".$mes_nombre." de ".$year.' <br><br><br><br>
		<b>RECIB&Iacute;</b><br>COORDINACION DEL CENTRO DE APOYO A LA TITULACION</p>
